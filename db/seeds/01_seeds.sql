...
INSERT INTO users (name, email, password, phone_number, is_admin)
VALUES ('Afreeda', 'afreeda@email.com', '743', 1234834567, TRUE);
INSERT iNTO users (name, email, password, phone_number)
