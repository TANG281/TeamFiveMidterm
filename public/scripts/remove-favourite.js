...
$(document).ready(function() {
  ...
  $(".card-body .btn-primary").on("click", function(event) {
    ...
    const itemPath = `/api/users/items/remove_favourite/${item_id}`;
    ...
    $.ajax({
      ...
      error: function(error) {
        console.log("Remove item from favourite failed! Error Message: ", error);
      }
